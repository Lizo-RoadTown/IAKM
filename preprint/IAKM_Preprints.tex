...
\abstract{Rapid emerging-technology work produces knowledge faster than organizations can preserve it. Methods, tools, dependencies, and decisions change while teams are building, so knowledge formed during debugging, integration, adaptation, and interpretation can disappear before documentation, mentorship, or succession planning catches it. Interface-Anchored Knowledge Mapping (IAKM) is a digital mapping system and methodology for capturing knowledge-relevant metadata as that knowledge emerges, without requiring the knowledge itself to be stored. It begins with preemptive decomposition of a modular sociotechnical system: components, couplings, and interfaces are identified before loss occurs, creating candidate structural locations where knowledge may appear. AI-assisted analysis then examines ordinary work artifacts at scale, treating digital interfaces as observability lenses where evidence about people, components, decisions, failures, and recoverability can be found. Verified records are anchored by a five-element coordinate: governing field, domain, interface layer, component, and knower. Interface layers are binding-relative, so the analytical lens is recorded inside the address, while structural location remains distinct from evidence capture and carrier location. A reference implementation in a distributed aerospace program produced 121 verified nodes and 24 verified edges in its most recent extraction run, under one binding and with partial coverage. The work remains at the collection stage; reproducibility, reviewer agreement, cross-domain validity, and predictive value remain untested.}

\keyword{Artificial intelligence; design structure matrix; domain analysis; knowledge loss; knowledge management; metadata; modularity; organizational memory; sociotechnical systems; verification}
...
\hline
\textbf{Method or record type} & \textbf{What it makes visible} & \textbf{What remains outside the record} \\
\hline
...
Recent work has sharpened this gap rather than closed it. Repository-history methods estimate how concentrated developer knowledge is and visualize where that concentration sits, while leaving open what knowledge exists outside the commit record and why a particular component matters \cite{avelino2016,cury2024,jabrayilzade2022}. Large language models have been applied to mining software repositories and to answering repository questions over knowledge graphs, extending how much of an artifact set can be searched and organized \cite{demartino2025,abedu2026}. Each of these widens what can be observed without settling how an observation becomes a checkable record.
...
Departures can reduce the expertise available to an organization, though severity by structural position is unsettled & \cite{galan2023} & A recovery record must capture position and knower before the question can be posed \\
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{fig2_timing_coverage_plane_print.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{fig1_three_senses_of_location_print.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{fig3_gradient_stays_a_vector_print.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{fig4_collection_stage_print.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{fig5_future_work_print.pdf}
...
documentation are openly available at
\url{https://github.com/Lizo-RoadTown/IAKM}. The verified map records
...
\bibitem{dalkey1963} N. Dalkey and O. Helmer, ``An experimental application of the DELPHI method to the use of experts,'' \emph{Manage. Sci.}, vol. 9, no. 3, pp. 458--467, Apr. 1963, doi: 10.1287/mnsc.9.3.458.

\bibitem{biber1993} D. Biber, ``Representativeness in corpus design,'' \emph{Literary Linguistic Comput.}, vol. 8, no. 4, pp. 243--257, 1993, doi: 10.1093/llc/8.4.243.

\bibitem{cury2024} O. Cury and G. Avelino, ``Knowledge islands: Visualizing developers knowledge concentration,'' in \emph{Proc. XXXVIII Simp\'{o}sio Brasileiro de Engenharia de Software (SBES)}, 2024, pp. 789--795, doi: 10.5753/sbes.2024.3610.

\bibitem{jabrayilzade2022} E. Jabrayilzade, M. Evtikhiev, E. T\"{u}z\"{u}n, and V. Kovalenko, ``Bus factor in practice,'' in \emph{Proc. 44th Int. Conf. Softw. Eng.: Softw. Eng. Pract. (ICSE-SEIP)}, 2022, pp. 97--106, doi: 10.1145/3510457.3513082.

\bibitem{demartino2025} V. De Martino, J. Casta\~{n}o, F. Palomba, X. Franch, and S. Mart\'{i}nez-Fern\'{a}ndez, ``A methodological framework for LLM-based mining of software repositories,'' arXiv:2508.02233, 2025.

\bibitem{abedu2026} S. Abedu, S. Khatoonabadi, and E. Shihab, ``Synergizing LLMs and knowledge graphs: A novel approach to software repository-related question answering,'' \emph{ACM Trans. Softw. Eng. Methodol.}, Feb. 2026, Art. no. 3796510, doi: 10.1145/3796510.
