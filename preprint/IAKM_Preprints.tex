...
% TODO(author): add your ORCID here and append \orcidA{} after the name.
...
%=================================================================
% TODO(author): the statements below are required by Preprints.org and are
% left as placeholders on purpose. Fill each one in before submitting.

\funding{TODO: state ``This research received no external funding'' or name
the funder and grant number.}

\institutionalreview{TODO: the reference implementation was deployed on a
university program involving human participants. State the IRB determination
(approval number, or an exemption determination), or ``Not applicable'' if
the deployment did not constitute human subjects research.}

\informedconsent{TODO: state the consent position, or ``Not applicable''.}

\dataavailability{TODO: state where the verified records, or a description of
them, can be obtained, or why they cannot be shared.}
