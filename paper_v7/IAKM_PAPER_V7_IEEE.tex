% ---------------------------------------------------------------
%  IEEE conference-format source, generated from IAKM_PAPER_V7_DRAFT-1.md
...
% draft-stage author decision markers; delete this macro (and the
% \authornote calls in the body) before submission
\newcommand{\authornote}[1]{%
  \par\smallskip\noindent
  \fcolorbox{black}{black!8}{%
    \parbox{0.93\columnwidth}{\footnotesize #1}}%
  \par\smallskip}
